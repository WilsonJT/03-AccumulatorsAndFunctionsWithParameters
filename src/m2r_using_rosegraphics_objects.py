...
#            renders a window of graphical images
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It is necessary so that the viewer can take their time looking at what was drawn;
#            it is needed because without it, the image closes immediately after being drawn
